...
1- While DLL injection is superior when available, games running on SDL/SDL2/SDL3 have a terrible time with DLL injection. Playing mods for old games that do not support other tools for shading would be a dead end.
